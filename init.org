...
* TODO Things to think and organize
- Note to future self: [[https://lists.gnu.org/archive/html/emacs-diffs/2025-04/msg00468.html][this]] stupid commit seems to break most face customizations. [[*Modeline]], [[*Tabs]], etc.
* TODO Strange bugs and their stranger fixes
...
#+begin_src emacs-lisp
(custom-set-faces
 '(default ((t (:weight medium :height 100 :family "Victor Mono"))))
...
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs
               (cons '((js-mode :language-id "javascript")
